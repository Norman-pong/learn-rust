// solutions/smart_pointers.rs — 本文件不会被 cargo 编译进 exercises
// 做题前先删掉 exercises/ 对应文件的 // I AM NOT DONE 标记再实现
// 需要查看时直接 `cat solutions/smart_pointers.rs`

// ============================================================
// Chapter 19: 智能指针 — 参考答案
// ============================================================

// Exercise smart_pointers1
// 使用 Box 在堆上分配递归链表，并计算所有节点值之和。
#[test]
fn smart_pointers1() {
    enum List {
        Cons(i32, Box<List>),
